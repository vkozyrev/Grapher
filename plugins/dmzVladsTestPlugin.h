#ifndef DMZ_VLADS_TEST_PLUGIN_DOT_H
#define DMZ_VLADS_TEST_PLUGIN_DOT_H
...
namespace dmz {
   ...
   class VladsTestPlugin :
      ...
      public:
         VladsTestPlugin (const PluginInfo &Info, Config &local);
         ~VladsTestPlugin ();
      ...
      private:
         VladsTestPlugin ();
         VladsTestPlugin (const VladsTestPlugin &);
         VladsTestPlugin &operator= (const VladsTestPlugin &);

   };
};

#endif // DMZ_VLADS_TEST_PLUGIN_DOT_H
